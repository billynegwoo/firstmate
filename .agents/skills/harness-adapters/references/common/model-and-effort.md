...
`../../../bin/fm-spawn.sh` accepts concrete `--harness`, `--model`, and `--effort` values selected at intake.
...
For dispatch `effort: "auto"`, follow the [configuration contract](../../../../../docs/configuration.md#crew-dispatch-profiles-configcrew-dispatchjson); never pass the literal `auto` to a launch.
